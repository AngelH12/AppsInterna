...
export const InventarioView = () => {
  ...
  return (
    <>
      <BreadCrumb title={"Inventario"} pageTitle={"Crear Inventario"} />
      {isSubmitLogin && (
        ...
        >
          <div className="flex items-center gap-4">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <ArchiveRestore size={48} className="text-white" />
            </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-4 pt-6">
          <div className="w-full md:w-2/5 p-4 bg-white rounded-md shadow-md h-[50%]">
            ...
            >
              <h3 className="text-2xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
                <Shield size={24} className="text-blue-600" /> {isEdit ? "Editar Inventario" : "Crear Inventario"}
              </h3>

              <p className="text-gray-600 text-sm">
                {isEdit
                  ? "Modifica la información del Inventario seleccionado."
                  : "Rellena el formulario para crear un nuevo Inventario."}
              </p>
            </motion.div>
          ...
          <div className="w-full md:w-3/5 bg-white p-6 rounded-lg shadow-md">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Visualiza, edita o elimina los Inventario disponibles en la lista.
              </p>
            </motion.div>
