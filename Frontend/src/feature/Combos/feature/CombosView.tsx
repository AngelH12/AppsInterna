...
export const CombosView = () => {
  ...
  return (
    <>
      <BreadCrumb title={"Combos"} pageTitle={"Crear Combos"} />
      {isSubmitLogin && (
        ...
        <div className="flex flex-col md:flex-row gap-4 pt-6">
          <div className="w-full md:w-2/5 p-4 bg-white rounded-md shadow-md h-[50%]">
            ...
            >
              <h3 className="text-2xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
                <Shield size={24} className="text-blue-600" /> {isEdit ? "Editar Combos" : "Crear Combos"}
              </h3>

              <p className="text-gray-600 text-sm">
                {isEdit
                  ? "Modifica la información del Combos seleccionado."
                  : "Rellena el formulario para crear un nuevo Combos."}
              </p>
            </motion.div>
          ...
          <div className="w-full md:w-3/5 bg-white p-6 rounded-lg shadow-md">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Visualiza, edita o elimina los Combos disponibles en la lista.
              </p>
            </motion.div>
