...
export const UsuariosView = () => {
  ...
  return (
    <>
      <BreadCrumb title={"Usuarios"} pageTitle={"Crear Usuarios"} />
      {isSubmitLogin && (
      ...
      <div className="w-full flex flex-col bg-gray-100 p-6 ">
        ...
        >
          ...
          <motion.img
            src="https://media.istockphoto.com/id/1173294674/es/vector/destinos-tur%C3%ADsticos-flat-vector-illustration.webp?s=2048x2048&w=is&k=20&c=dkQlJL9NbZBtV9juDBglDJoWzkxMr3CMrBLr77PnU1c="
            alt="Usuarios"
            className="rounded-full shadow-md h-14"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.5 }}
          />
        ...
        <div className="flex flex-col md:flex-row gap-4 pt-6">
          <div className="w-full md:w-2/5 p-4 bg-white rounded-md shadow-md h-[50%]">
            ...
            >
              <h3 className="text-2xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
                <Shield size={24} className="text-blue-600" /> {isEdit ? "Editar Usuario" : "Crear Usuario"}
              </h3>
          ...
          <div className="w-full md:w-3/5 bg-white p-6 rounded-lg shadow-md">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">
                Visualiza, edita o elimina los Usuarios disponibles en la lista.
              </p>
            </motion.div>
