  ...
  return (
    <Fragment>
      <div className="grid grid-cols-12 lg:grid-cols-12 gap-3">
        {isSelect && (
          <div className="self-center col-span-12 md:col-span-6 lg:col-span-6 gap-3">
            <label className="px-2.5 py-1 mr-4 text-xs font-medium inline-block rounded border bg-slate-500 border-slate-500 text-slate-50">
              {" "}
              Mostrar filas{" "}
            </label>
            <select
        ...
        <div className="self-center col-span-12 md:col-span-6 md:place-self-end  lg:col-span-6 lg:place-self-end">
          {isGlobalFilter && (
            <div className=" gap-x-3 items-center w-1/2">
              <DebouncedInput
                value={globalFilter ?? ""}
                onChange={(value) => setGlobalFilter(String(value))}
                className="w-1/2 py-2 pr-4 text-sm text-topbar-item bg-topbar border border-topbar-border rounded pl-2 placeholder:text-slate-400 form-control focus-visible:outline-0 min-w-[200px] focus:border-blue-400 group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:border-topbar-border-dark group-data-[topbar=dark]:placeholder:text-slate-500 group-data-[topbar=dark]:text-topbar-item-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:border-topbar-border-brand group-data-[topbar=brand]:placeholder:text-blue-300 group-data-[topbar=brand]:text-topbar-item-brand group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:border-zink-500 group-data-[topbar=dark]:dark:text-zink-100"
                placeholder={"Buscar"}
              />
            </div>
          )}
                    ...
                    >
                      {header.isPlaceholder ? null : (
                        <React.Fragment>
                          ...
                          {header.column.getCanFilter() ? null : null}
